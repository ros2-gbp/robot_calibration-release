...
%global pkg_name robot_calibration_msgs
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-robot-calibration-msgs
Version:        0.10.1
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Michael Ferguson <mike@vanadiumlabs.com> - 0.10.1-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Michael Ferguson <mike@vanadiumlabs.com> - 0.10.1-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Michael Ferguson <mike@vanadiumlabs.com> - 0.10.1-1
- Autogenerated by Bloom
